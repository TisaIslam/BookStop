<?php
	...
	$i=1;
		...
		$item1=$item1='<div class="product-image-wrapper" ><div class="single-products"style ="float:left"><div class="productinfo text-center"> <img src="'.$array[2].'" alt="" style="height:200px;width:250px;"/>';
		$pri=$array[7];
		$str="TK ". (string)$pri;
		$item2='<p>'.$str.'</p>';
		$item3='<p>'.$array[3].'</p>';
