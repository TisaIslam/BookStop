<?php
	//code for showing all the products	
	...
	$i=1;
		...
		$item7='<a href="#" name="'.$array[0].'" onClick="create(this.name,1);loadmodal();return false;" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a></div></div></div></div>';
